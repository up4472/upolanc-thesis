...
def evaluate_epoch (model : Module, params : Dict[str, Any], desc : str = 'Progress', validation : bool = False, regression : bool = False) -> Dict[str, Any] :
	"""
	Doc
	"""
...
def evaluate (model : Module, params : Dict[str, Any], regression : bool = False) -> Dict[str, Dict] :
	"""
	Doc
	"""
