...
#SBATCH --output=/d/hpc/home/up4472/workspace/upolanc-thesis/slurm/bert-extract-%j.out
#SBATCH --error=/d/hpc/home/up4472/workspace/upolanc-thesis/slurm/bert-extract-%j.err
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
export PATH_OUTS=$PATH_ROOT/output/nbp12-bert/$DATA_FILTER/out/$NAME_MODEL/$DATA_KMER/$DATA_SEQUENCE
export PATH_TEMP=$PATH_ROOT/output/nbp12-bert/$DATA_FILTER/tmp/$NAME_MODEL/$DATA_KMER/$DATA_SEQUENCE
